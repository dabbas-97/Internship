                            ...
                            <div className='form-row my-3'>
                                <div className='col-12'>
                                    <select name='gpa' className=' custom-select w-50' onChange={this.props.handleChange('gpa')} value={values.gpa}>
                                        ...
                                        <option value='3.0'> Very Good Or Higher </option>
                                        <option value='2.5'>Good Or Higher</option>
                                        <option value='2.0'>Pass Or Higher</option>
                                        <option value='1.5'>Weak Or Higher</option>
                                    </select>
                                </div>
                            </div>
                        </li>
